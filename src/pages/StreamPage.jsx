                ...
                <div style={styles.featuredPlayer}>
                  {getEmbedSrc(selectedFeatured) ? (
                    ...
                    <div style={styles.youtubeFallback}>
                      <div style={{ fontSize: 22, fontWeight: 600, marginBottom: 8, color: "#1d1d1f", letterSpacing: -0.3 }}>YouTube channel live link</div>
                      <p style={{ color: "#6e6e73", maxWidth: 520, textAlign: "center" }}>YouTube handle live pages cannot always be embedded without a video ID. Open the live page to see whether JPC_Racing is currently broadcasting.</p>
...
function DriverStreamCard({ driver, stream, isLive, team, manufacturer, onWatch }) {
  const logo = getTeamLogo(team);
  return (
    <div style={{ ...styles.driverCard, borderColor: isLive ? "#ff3b30" : "rgba(0,0,0,0.06)" }}>
...
const GLASS_BG_STRONG = "rgba(255,255,255,0.82)";
...
const mobileStyles = {
  ...
  kicker: { color: GOLD, fontSize: 11, fontWeight: 700, letterSpacing: 1.8, textTransform: "uppercase" },
  title: { fontSize: 32, fontWeight: 700, lineHeight: 1.05, marginTop: 4, letterSpacing: -0.5, color: TEXT_PRIMARY },
  subtitle: { color: TEXT_SECONDARY, fontSize: 14, lineHeight: 1.4, marginTop: 6, fontWeight: 400 },
  summaryRow: {
    display: "grid",
  ...
  content: { padding: 14, display: "grid", gap: 14 },
  card: {
    background: GLASS_BG,
    backdropFilter: "blur(24px) saturate(180%)",
    WebkitBackdropFilter: "blur(24px) saturate(180%)",
  ...
  sectionTitle: { fontSize: 19, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: -0.3 },
  sectionSub: { color: TEXT_SECONDARY, fontSize: 12.5, marginTop: 3 },
  platformBadge: {
  ...
  featuredName: { fontSize: 19, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: -0.3 },
  featuredMeta: { color: TEXT_SECONDARY, fontSize: 12, textTransform: "uppercase", fontWeight: 600, letterSpacing: 0.4 },
  watchPrimary: {
    display: "block",
    textAlign: "center",
    background: TEXT_PRIMARY,
  ...
  filterStack: { display: "grid", gap: 12, marginTop: 12 },
  label: { display: "grid", gap: 6, fontSize: 11, fontWeight: 600, color: TEXT_SECONDARY, textTransform: "uppercase", letterSpacing: 0.5 },
  input: {
    width: "100%",
  ...
  teamLogo: { width: 42, height: 42, borderRadius: "50%", objectFit: "cover", border: "1px solid rgba(0,0,0,0.08)", background: "#fff" },
  carNumber: { fontSize: 28, fontWeight: 700, lineHeight: 1, color: TEXT_PRIMARY, letterSpacing: -0.5 },
  livePill: { marginLeft: "auto", background: LIVE_RED, color: "white", borderRadius: 999, padding: "5px 10px", fontSize: 11, fontWeight: 700 },
  offlinePill: { marginLeft: "auto", background: "rgba(0,0,0,0.06)", borderRadius: 999, padding: "5px 10px", fontSize: 11, fontWeight: 600, color: TEXT_SECONDARY },
  driverName: { fontSize: 18, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: -0.2 },
  driverMeta: { color: TEXT_SECONDARY, fontSize: 13 },
  statsRow: {
    display: "grid",
    gridTemplateColumns: "repeat(3, 1fr)",
    gap: 8,
  ...
  muted: { color: TEXT_SECONDARY, marginTop: 8 },
  emptyBox: { background: "rgba(0,0,0,0.03)", borderRadius: 16, padding: 18, color: TEXT_SECONDARY, textAlign: "center" },
  adminToggle: {
    width: "100%",
    background: TEXT_PRIMARY,
    color: "white",
...
const styles = {
  page: { minHeight: "100vh", background: "linear-gradient(180deg, #f5f5f7 0%, #ffffff 40%, #f5f5f7 100%)", color: TEXT_PRIMARY, fontFamily: FONT_STACK, WebkitFontSmoothing: "antialiased" },
  tickerWrap: { height: 46, display: "flex", alignItems: "center", background: GLASS_BG_STRONG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", borderBottom: "1px solid rgba(0,0,0,0.06)", overflow: "hidden", position: "sticky", top: 0, zIndex: 50 },
  tickerLabel: { height: "100%", background: GOLD, color: "#1d1d1f", padding: "0 20px", display: "flex", alignItems: "center", fontWeight: 700, letterSpacing: 1, fontSize: 13 },
  ...
  tickerItem: { display: "inline-block", marginRight: 70, fontSize: 13, fontWeight: 500, color: TEXT_SECONDARY, textTransform: "uppercase", letterSpacing: 0.3 },
  hero: { padding: "36px 30px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 20, borderBottom: "1px solid rgba(0,0,0,0.06)" },
  kicker: { color: GOLD, fontSize: 13, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" },
  title: { margin: "4px 0", fontSize: 44, lineHeight: 1.05, fontWeight: 700, letterSpacing: -1, color: TEXT_PRIMARY },
  subtitle: { margin: 0, color: TEXT_SECONDARY, fontSize: 15, fontWeight: 400 },
  livePanel: { background: GLASS_BG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: GLASS_BORDER, borderRadius: 22, padding: "18px 26px", minWidth: 150, textAlign: "center", boxShadow: GLASS_SHADOW },
  liveText: { color: LIVE_RED, fontSize: 13, fontWeight: 700, letterSpacing: 0.5 },
  liveCount: { fontSize: 42, fontWeight: 700, lineHeight: 1, color: TEXT_PRIMARY, letterSpacing: -1 },
  liveSub: { color: TEXT_SECONDARY, fontSize: 12, fontWeight: 500 },
  layout: { display: "grid", gridTemplateColumns: "2.5fr 1fr", gap: 22, padding: 24, alignItems: "start" },
  mainColumn: { display: "grid", gap: 18 },
  sideColumn: { display: "grid", gap: 18 },
  sectionCard: { background: GLASS_BG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: GLASS_BORDER, borderRadius: 22, padding: 20, boxShadow: GLASS_SHADOW },
  featuredCard: { background: GLASS_BG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: `1px solid ${GOLD}55`, borderRadius: 22, padding: 20, boxShadow: GLASS_SHADOW },
  filtersCard: { background: GLASS_BG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: GLASS_BORDER, borderRadius: 22, padding: 20, boxShadow: GLASS_SHADOW },
  adminCard: { background: GLASS_BG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: GLASS_BORDER, borderRadius: 22, padding: 20, boxShadow: GLASS_SHADOW },
  sectionHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18, gap: 12, flexWrap: "wrap" },
  sectionTitle: { margin: 0, fontSize: 22, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: -0.4 },
  sectionSub: { margin: "4px 0 0", color: TEXT_SECONDARY, fontSize: 13.5 },
  redBadge: { background: LIVE_RED, color: "white", padding: "7px 14px", borderRadius: 999, fontSize: 12, fontWeight: 700 },
  darkBadge: { background: TEXT_PRIMARY, color: "white", padding: "7px 14px", borderRadius: 999, fontSize: 12, fontWeight: 600 },
  featuredPlayer: { height: 460, background: "#000", borderRadius: 18, overflow: "hidden", border: "1px solid rgba(0,0,0,0.08)" },
  youtubeFallback: { height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, background: "#f5f5f7" },
  featuredFooter: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: 14, flexWrap: "wrap" },
  featuredTitle: { fontSize: 19, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: -0.3 },
  featuredMeta: { color: TEXT_SECONDARY, fontSize: 13, marginTop: 3 },
  filterGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14 },
  filterLabel: { display: "grid", gap: 6, fontSize: 12, fontWeight: 600, color: TEXT_SECONDARY, textTransform: "uppercase", letterSpacing: 0.5 },
  input: { width: "100%", background: "rgba(0,0,0,0.04)", color: TEXT_PRIMARY, border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "10px 12px", boxSizing: "border-box", fontFamily: FONT_STACK, fontSize: 14 },
  adminLoginRow: { display: "grid", gridTemplateColumns: "1fr auto", gap: 10 },
  adminFormGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(190px, 1fr))", gap: 14 },
  checkboxLabel: { display: "flex", alignItems: "center", gap: 8, background: "rgba(0,0,0,0.04)", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "10px 12px", fontWeight: 600, color: TEXT_PRIMARY },
  adminActions: { display: "flex", gap: 8, alignItems: "end", flexWrap: "wrap" },
  primaryButton: { background: TEXT_PRIMARY, color: "white", border: "none", borderRadius: 12, padding: "10px 16px", fontWeight: 600, cursor: "pointer", fontFamily: FONT_STACK },
  secondaryButton: { background: "rgba(0,0,0,0.05)", color: TEXT_PRIMARY, border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "10px 16px", fontWeight: 600, cursor: "pointer", fontFamily: FONT_STACK },
  smallButton: { background: "rgba(0,0,0,0.05)", color: TEXT_PRIMARY, border: "1px solid rgba(0,0,0,0.08)", borderRadius: 10, padding: "7px 11px", fontWeight: 600, cursor: "pointer", fontSize: 12, fontFamily: FONT_STACK },
  adminStreamList: { display: "grid", gap: 8, marginTop: 16 },
  adminStreamRow: { display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center", background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.06)", borderRadius: 14, padding: 10, flexWrap: "wrap" },
  rowActions: { display: "flex", gap: 6, flexWrap: "wrap" },
  adminMeta: { color: TEXT_SECONDARY, fontSize: 12, marginTop: 3 },
  success: { marginTop: 10, color: "#34c759", fontWeight: 600 },
  error: { marginTop: 10, color: LIVE_RED, fontWeight: 600 },
  driverGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 16 },
  driverCard: { background: "rgba(255,255,255,0.75)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(0,0,0,0.06)", borderRadius: 20, padding: 16, display: "grid", gap: 10, boxShadow: "0 6px 20px rgba(0,0,0,0.05)" },
  driverCardTop: { display: "flex", alignItems: "center", gap: 10 },
  teamLogo: { width: 44, height: 44, borderRadius: "50%", objectFit: "cover", background: "#fff", border: "1px solid rgba(0,0,0,0.08)" },
  numberBlock: { fontSize: 26, fontWeight: 700, lineHeight: 1, color: TEXT_PRIMARY, letterSpacing: -0.5 },
  livePill: { marginLeft: "auto", background: LIVE_RED, color: "white", borderRadius: 999, padding: "5px 10px", fontSize: 11, fontWeight: 700 },
  offlinePill: { marginLeft: "auto", background: "rgba(0,0,0,0.06)", borderRadius: 999, padding: "5px 10px", fontSize: 11, fontWeight: 600, color: TEXT_SECONDARY },
  driverCardName: { fontSize: 17, fontWeight: 600, color: TEXT_PRIMARY, letterSpacing: -0.2 },
  driverCardMeta: { color: TEXT_SECONDARY, fontSize: 13 },
  cardStatsRow: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8 },
  watchButton: { background: TEXT_PRIMARY, color: "white", textDecoration: "none", borderRadius: 12, padding: "10px 14px", fontWeight: 600 },
  watchButtonFull: { background: GOLD, color: "#1d1d1f", border: "none", borderRadius: 12, padding: "10px 14px", fontWeight: 700, cursor: "pointer" },
  noStream: { color: TEXT_SECONDARY, background: "rgba(0,0,0,0.03)", borderRadius: 12, padding: "10px 12px", textAlign: "center", fontWeight: 500 },
  emptyBox: { minHeight: 280, background: "rgba(0,0,0,0.02)", borderRadius: 20, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", color: TEXT_SECONDARY, textAlign: "center" },
  emptySmall: { background: "rgba(0,0,0,0.02)", borderRadius: 16, padding: 20, color: TEXT_SECONDARY, textAlign: "center" },
  card: { background: GLASS_BG, backdropFilter: "blur(24px) saturate(180%)", WebkitBackdropFilter: "blur(24px) saturate(180%)", border: GLASS_BORDER, borderRadius: 20, padding: 18, boxShadow: GLASS_SHADOW },
  cardTitle: { margin: "0 0 14px", fontWeight: 600, fontSize: 17, color: TEXT_PRIMARY, letterSpacing: -0.3 },
  infoRow: { display: "flex", justifyContent: "space-between", gap: 12, padding: "10px 0", borderBottom: "1px solid rgba(0,0,0,0.06)", color: TEXT_SECONDARY, fontSize: 14 },
  driverNumber: { fontSize: 40, fontWeight: 700, lineHeight: 1, color: TEXT_PRIMARY, letterSpacing: -1 },
  driverName: { fontSize: 17, fontWeight: 600, marginTop: 6, color: TEXT_PRIMARY },
  driverTeam: { color: TEXT_SECONDARY, marginTop: 3, fontSize: 13.5 },
  statGrid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginTop: 14 },
  statBox: { background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.06)", borderRadius: 14, padding: 10, textAlign: "center", display: "grid", gap: 3 },
  watchPartyButton: { width: "100%", background: "rgba(0,0,0,0.03)", color: TEXT_PRIMARY, border: "1px solid rgba(0,0,0,0.06)", borderRadius: 12, padding: 10, display: "flex", justifyContent: "space-between", gap: 8, cursor: "pointer", marginBottom: 8, textAlign: "left", fontFamily: FONT_STACK },
  liveRow: { width: "100%", background: "rgba(0,0,0,0.03)", color: TEXT_PRIMARY, border: "1px solid rgba(0,0,0,0.06)", borderRadius: 12, padding: "9px 11px", display: "flex", justifyContent: "space-between", gap: 8, cursor: "pointer", marginBottom: 7, textAlign: "left", fontFamily: FONT_STACK },
  standingRow: { display: "grid", gridTemplateColumns: "30px 1fr auto", gap: 8, padding: "8px 0", borderBottom: "1px solid rgba(0,0,0,0.06)", alignItems: "center" },
  position: { color: GOLD, fontWeight: 700 },
  driverMini: { fontSize: 13, fontWeight: 500, color: TEXT_PRIMARY },
